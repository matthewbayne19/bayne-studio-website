...
export function InfrastructureSection() {
  ...
  return (
    <section id="work" ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-8">
              {highlights.map((stat) => (
                <div key={stat.label}>
                  <div className="text-3xl lg:text-4xl font-display mb-2">{stat.value}</div>
          ...
          >
            <div className="border border-foreground/10 bg-foreground/[0.02]">
              ...
              <div className="p-8">
                <div className="mb-8">
                  <h3 className="text-2xl font-display mb-2">The Backroom</h3>
